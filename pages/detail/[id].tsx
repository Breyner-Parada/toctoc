...
// const Detail = <T extends IProps>({postDetails}: T) => {
//   return (
//     <div>Detail</div>
//   );
// };
      ...
      <div className='relative flex-2 w-[1000px] lg:w-9/12 flex justify-center items-center bg-blurred-img bg-no-repeat bg-cover bg-center'>
        ...
        <div className='relative'>
          <div className='lg:h-[100vh] h-[60vh]'>
            <video src={post.video.asset.url} className='h-full cursor-pointer' ref={videoRef} loop onClick={onVideoClicked}>
        ...
        <div className='absolute bottom-5 lg:bottom-10 right-5 lg:right-10 cursor-pointer'>
          {isVideoMuted ? (
            ...
            (
              <button onClick={onVideoMuted}>
                <HiVolumeUp className='text-2xl lg:text-4xl text-white' />
              </button>
            )}
        </div>
      </div>
